...
- RiskAssessment preserves the complete public risk decision and derives its finding material identity; `risk_assessment_id` uses `ux-skill:risk-assessment:v1` over the complete id-less public body.
