...
const validOutput=()=>({schema_version:'evaluation-output-v1',behavior_version:'0.1.0',input_digest:digest('1'),evaluator_digest:digest('2'),run_status:'completed_clear',validation_errors:[],rule_evaluations:[],findings:[],run_issues:[],claim_assessments:[{claim_assessment_id:'assessment-1',claim_id:'claim-1',admissible_conclusion:'descriptive',assessed_predicate:{relation_kind:'descriptive',context_id:'context-1',time_scope_id:'time-1',subject_id:'subject-1',value:'observed'},evidence_grade:'limited',check_results:[],dimension_scores:[],reason_codes:[]}],risk_assessments:[],recommendation_assessments:[],release_recommendation:null,resolution_traces:[],inquiry_validation:null,coverage_gaps:[]});
